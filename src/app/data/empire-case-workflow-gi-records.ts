...
export const EMPIRE_CASE_WORKFLOW_GI_RECORDS: Record<string, EmpireCaseWorkflowGiRecord> = {
  ...
  [EMPIRE_DEMO_CASE_IDS.nbFullUw]: {
    ...
    generalInformation: {
      sections: [],
      aiSummary: {
        text: 'Amélie Dubois applied for $500,000 Solution 20 participating whole life via Empire Life advisor portal. Non-smoker, BMI 25. Attending physician statement ordered 12 May — outstanding. Preliminary standard terms anticipated pending medical evidence.',
        confidence: 73,
        generatedAt: '2026-05-17',
      },
      cards: [
        ...
        },
        {
          ...
          fields: [
            ...
            { label: 'APS', value: 'Outstanding', valueType: 'pill_warning' },
            { label: 'Province', value: 'Québec' },
            { label: 'Advisor firm', value: 'Morin Financial Group' },
          ],
        },
        {
          ...
          aiGenerated: true,
          summary: 'Provisional standard — pending APS',
          summaryStatus: 'warning',
          note: 'Final rating subject to attending physician statement.',
          factors: [
            { name: 'BMI 25.0 (borderline)', direction: 'debit', points: '+10', barPct: 20 },
            { name: 'Non-smoker', direction: 'credit', points: '-10', barPct: 20 },
          ],
        },
      ],
      collapsibles: [
        { id: 'participating', title: 'Participating dividends', subtitle: 'Solution 20 product features' },
        { id: 'medicals', title: 'Medicals', subtitle: 'APS chase if not received by 22 May' },
      ],
    },
  },
