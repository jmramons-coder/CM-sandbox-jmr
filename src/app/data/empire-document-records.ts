...
export const EMPIRE_DOCUMENT_RECORDS: DatasetDocumentRecord[] = [
  ...
  doc('doc_emp_nb_aps_request', NB, 'APS request — Clinique Médicale du Plateau.pdf', 'Medical', {
    uploaded: 'May 11, 2026',
    uploadedAt: '2026-05-11',
    source: 'AI Agent — draft',
    claimant: 'Amélie Dubois',
    stage: 'req_gathering',
    linkedRequirementId: 'req_emp_nb_002',
    linkedRequirement: 'Attending physician statement (APS)',
    reqContext: 'Draft APS order to primary care — pending underwriter release.',
    aiSummary: 'APS request drafted after Rx review identified treated hypertension; not yet sent to clinic.',
    aiInsight: true,
    linkedObjects: [{ kind: 'client', id: 'CLI-EMP-005', label: 'Amélie Dubois', role: 'applicant' }],
  }),
