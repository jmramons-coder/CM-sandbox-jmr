...
export const EMPIRE_REQUIREMENT_RECORDS: DatasetRequirementRecord[] = [
  ...
  req('req_emp_nb_003', NB, 'MIB search', 'Fulfilled', 'application', {
    source: 'nb_rules_engine',
    sourceType: 'system',
    responsibleParty: 'Underwriting',
    dueDate: '2026-05-08',
    followUpDate: '2026-05-08',
    linkedDocs: ['doc_emp_nb_mib'],
    linkedTasks: ['task_emp_nb_010'],
    aiSummary: 'MIB search clear — no adverse alerts at submission.',
    history: [
      { date: '2026-05-08', action: 'Requirement created at application submission', user: 'System', dot: 'blue' },
      { date: '2026-05-08', action: 'MIB inquiry ordered automatically', user: 'System', dot: 'amber' },
      { date: '2026-05-08', action: 'MIB clear — no adverse alerts', user: 'System', dot: 'green' },
    ],
  }),
  req('req_emp_nb_005', NB, 'Blood and urine', 'In Queue', 'application', {
    category: 'Medical',
    source: 'paramed_network',
    sourceType: 'system',
    responsibleParty: 'Dynacare',
    dueDate: '2026-05-08',
    followUpDate: '2026-05-08',
    linkedDocs: ['doc_emp_nb_lab_req'],
    linkedTasks: ['task_emp_nb_011'],
    aiSummary: 'Paramedical lab requisition ordered at submission — blood and urine profile pending collection at Dynacare Ottawa.',
    fulfillmentCriteria: ['Blood profile collected', 'Urinalysis completed', 'Results received from lab network'],
    context: {
      type: 'application',
  ...
  req('req_emp_nb_006', NB, 'RX (prescription medication) report', 'Fulfilled', 'application', {
    category: 'Medical',
    source: 'milliman_intelliscript',
    sourceType: 'system',
    responsibleParty: 'Underwriting',
    dueDate: '2026-05-08',
    followUpDate: '2026-05-11',
    linkedDocs: ['doc_emp_nb_rx'],
    linkedTasks: ['task_emp_nb_012'],
    aiSummary: 'Milliman IntelliScript Rx report received 11 May — lisinopril and amlodipine identified; AI recommends APS for treated hypertension.',
    fulfillmentCriteria: ['Rx database search complete', 'Medication history reviewed', 'Discrepancies resolved or waived'],
    context: {
      type: 'application',
      label: 'Prescription history',
      description: 'Ordered May 8, 2026 at submission; results received and AI-reviewed 11 May.',
      kv: [{ label: 'Provider', value: 'Milliman IntelliScript' }],
    },
    history: [
      { date: '2026-05-08', action: 'Requirement created at application submission', user: 'System', dot: 'blue' },
      { date: '2026-05-08', action: 'Rx report ordered at submission', user: 'System', dot: 'amber' },
      { date: '2026-05-11', action: 'IntelliScript results received and receipted', user: 'System', dot: 'green' },
      { date: '2026-05-11', action: 'AI recommends APS for treated hypertension', user: 'AI Agent', dot: 'blue' },
    ],
  }),
  req('req_emp_nb_007', NB, 'Scuba Questionnaire', 'Outstanding', 'application', {
    ...
    followUpDate: '2026-05-08',
    rag: 'Amber',
    responsibleParty: 'Applicant / Advisor',
    notes: 'Internal: chase advisor if not returned by 15 May — blocks medical advance.',
    linkedTasks: ['task_emp_nb_013', 'task_emp_nb_014'],
    linkedDocs: [],
    aiSummary:
      'AI flagged recreational scuba diving on APP-4401 at submission — Empire Life scuba questionnaire ordered and outstanding.',
    blockingImpact: {
      severity: 'medium',
      reason: 'Scuba questionnaire must be completed before medical requirements can advance',
    },
    fulfillmentCriteria: ['Questionnaire sent to applicant', 'Signed scuba disclosure received', 'Underwriting review complete'],
    context: {
      type: 'application',
      label: 'Avocation disclosure',
      description: 'First-step requirement ordered automatically when scuba diving was disclosed on submission.',
      kv: [
        { label: 'Ordered by', value: 'AI Agent · May 8, 2026' },
        { label: 'Disclosure', value: 'Recreational scuba diving · ~12 dives/year' },
      ],
    },
    history: [
      { date: '2026-05-08', action: 'Requirement created — scuba disclosure on application', user: 'System', dot: 'blue' },
      { date: '2026-05-08', action: 'AI recommendation — scuba questionnaire required', user: 'AI Agent', dot: 'blue' },
      { date: '2026-05-08', action: 'Questionnaire ordered — sent to advisor portal', user: 'System', dot: 'amber' },
      { date: '2026-05-12', action: 'Reminder sent to advisor — still outstanding', user: 'System', dot: 'amber' },
    ],
  }),
  req('req_emp_nb_002', NB, 'Attending physician statement (APS)', 'Outstanding', 'req_gathering', {
    category: 'Medical',
    source: 'ai_rule_engine',
    sourceType: 'system',
    aiGenerated: true,
    trigger: 'Rx report — treated hypertension',
    dueDate: '2026-05-22',
    followUpDate: '2026-05-11',
    responsibleParty: 'Clinique Médicale du Plateau',
    notes: 'Internal: APS ordered 11 May after Victor Ramon approved Rx-triggered recommendation.',
    linkedTasks: ['task_emp_nb_015', 'task_emp_nb_016', 'task_emp_nb_017', 'task_emp_nb_018'],
    linkedDocs: [],
    blockingImpact: { severity: 'medium', reason: 'Final underwriting rating held pending APS' },
    aiSummary:
      'AI recommended APS after Rx review — lisinopril and amlodipine for treated high blood pressure. Underwriter to approve and order from Clinique Médicale du Plateau.',
    fulfillmentCriteria: ['Rx report received and reviewed', 'APS recommendation approved', 'APS request sent to physician', 'Attending physician statement returned'],
    context: {
      type: 'application',
      label: 'Attending physician statement',
      description: 'APS ordered 11 May 2026 after IntelliScript flagged antihypertensive medications and underwriter approved the order.',
      kv: [
        { label: 'Ordered', value: '11 May 2026 · Victor Ramon' },
        { label: 'Physician', value: 'Clinique Médicale du Plateau — Montréal' },
        { label: 'Rx trigger', value: 'Lisinopril · amlodipine — treated hypertension' },
      ],
    },
    history: [
      { date: '2026-05-08', action: 'Requirement created — deferred pending Rx report', user: 'System', dot: 'blue' },
      { date: '2026-05-11', action: 'Rx report received — AI recommends APS', user: 'AI Agent', dot: 'blue' },
      { date: '2026-05-11', action: 'Underwriter approved APS order', user: 'Victor Ramon', dot: 'green' },
      { date: '2026-05-11', action: 'APS request sent to Clinique Médicale du Plateau', user: 'Victor Ramon', dot: 'amber' },
    ],
  }),
