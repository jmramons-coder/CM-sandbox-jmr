...
export const EMPIRE_REQUIREMENT_RECORDS: DatasetRequirementRecord[] = [
  ...
  req('req_emp_nb_003', NB, 'MIB search', 'Fulfilled', 'application', {
    ...
    history: [{ date: '2026-05-08', action: 'MIB clear at submission', user: 'System', dot: 'green' }],
  }),
  ...
  req('req_emp_nb_006', NB, 'RX (prescription medication) report', 'Fulfilled', 'application', {
    ...
    history: [
      ...
      { date: '2026-05-11', action: 'IntelliScript results received — AI recommends APS for treated hypertension', user: 'AI Agent', dot: 'blue' },
    ],
  }),
  req('req_emp_nb_007', NB, 'Scuba Questionnaire', 'Outstanding', 'application', {
    ...
    linkedTasks: ['task_emp_nb_013'],
    linkedDocs: ['doc_emp_nb_scuba_sent', 'doc_emp_nb_scuba_reminder'],
    aiSummary:
    ...
    history: [
      { date: '2026-05-08', action: 'AI recommendation — scuba questionnaire required at submission', user: 'AI Agent', dot: 'blue' },
      { date: '2026-05-08', action: 'Requirement ordered — sent to advisor portal', user: 'System', dot: 'amber' },
    ],
  }),
  req('req_emp_nb_002', NB, 'Attending physician statement (APS)', 'Outstanding', 'req_gathering', {
    ...
    context: {
      type: 'application',
      label: 'Medicals',
      description: 'AI planned APS order after IntelliScript flagged antihypertensive medications; underwriter approval required before ordering.',
      kv: [
        { label: 'Recommended', value: '11 May 2026 · AI Agent' },
    ...
    history: [
      { date: '2026-05-08', action: 'APS deferred at submission — pending Rx report', user: 'System', dot: 'amber' },
      { date: '2026-05-11', action: 'Rx report received — AI recommends APS for treated hypertension', user: 'AI Agent', dot: 'blue' },
    ],
  }),
